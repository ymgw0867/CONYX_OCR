...
namespace CONYX_OCR.common
{
    class global
    {
        ...
        #region 画像表示倍率（%）・座標
        public static float miMdlZoomRate = 0f;         // 現在の表示倍率
        public static float ZOOM_RATE = 0.38f;          // 標準倍率
        public static float ZOOM_MAX = 2.00f;           // 最大倍率
        public static float ZOOM_MIN = 0.05f;           // 最小倍率
        public static float ZOOM_STEP = 0.05f;          // ステップ倍率
        public static float ZOOM_NOW = 0.0f;            // 現在の倍率

        public static int RECTD_NOW = 0;            // 現在の座標
        public static int RECTS_NOW = 0;            // 現在の座標
        ...
        #region ローカルMDB関連定数
        public const string MDBFILE = "CONYX_CLI.mdb";          // MDBファイル名
        public const string MDBTEMP = "CONYX_CLI _TEMP.mdb";    // 最適化一時ファイル名
        ...
        public static int cnfMarume = 0;                // 丸め単位
        public static string cnfEditBackColor = string.Empty;   // 編集済み背景色
        #endregion
        ...
        // 事由区分：2018/08/10
        public static int JIYUKBN_TOKKYU = 1;           // 特休
        public static int JIYUKBN_YUKYU = 2;            // 有休
        public static int JIYUKBN_CHOKKOU = 4;          // 直行
        public static int JIYUKBN_CHOKKI = 5;           // 直帰
        public static int JIYUKBN_CHOKKOUCHOKKI = 6;    // 直行直帰
        public static int JIYUKBN_SHUCCHOU = 7;         // 出張
        public static int JIYUKBN_CHIEN = 8;            // 遅延
        public static int JIYUKBN_KEKKIN = 9;           // 欠勤
        public static int JIYUKBN_FURIKYU = 16;         // 振休
        public static int JIYUKBN_SONOTA = 0;           // その他
        
        // 事由取得単位：2018/08/10
        public static int JIYUTANI_ALLDAY = 0;          // 終日
        public static int JIYUTANI_HALF = 1;            // 半日
        public static int JIYUTANI_255 = 255;           // その他
    }
}
